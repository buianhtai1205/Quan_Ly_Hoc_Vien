...
Route::group(['prefix' => '/manage_course', 'as' => 'manage_courses.', 'middleware' => 'auth:academic'], function() {
...
Route::group(['prefix' => '/manage_student_class', 'as' => 'manage_student_classes.', 'middleware' => 'auth:academic'], function() {
...
Route::group(['prefix' => '/manage_student', 'as' => 'manage_students.', 'middleware' => 'auth:academic'], function() {
...
Route::group(['prefix' => '/manage_section', 'as' => 'manage_sections.', 'middleware' => 'auth:academic'], function() {
...
Route::group(['prefix' => '/divide_class_student', 'as' => 'divide_class_students.', 'middleware' => 'auth:academic'], function() {
