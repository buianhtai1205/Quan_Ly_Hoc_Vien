...
@section('content')
    ...
    <div class="content-title">
        <i class="fa-solid fa-angles-right icon-sidebar"></i>Manage Section / Insert Automatic
    </div>
    ...
    <div class="content-main">
        <form action="{{ route('manage_sections.store_automatic') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-row">
